...
_Last updated: 2026-07-13 (Minimum North Star Gate 0 design drafted on
...
5. **PENDING / DAVID:** token rotation for the leaked 2026-07-04 token remains David-owned/trivial; do
   not print the token.
**=> NEXT (priority order):** (1) verify and PR the Gate 0 design with a posted adversarial review;
(2) David merges; (3) run R0 + W0 + C0 `$0` readiness only; (4) write a paid pre-registration only if
all three return `GO`.
